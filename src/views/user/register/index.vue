    ...
    <el-form ref="registerForm" :model="registerForm" :rules="registerRules" class="login-form" auto-complete="on" label-position="left">
      ...
      <el-form-item prop="apassword">
        ...
        <el-input
          ...
          @keyup.enter.native="handleLogin"
        />
        <span class="show-pwd" @click="showaPwd">
          <svg-icon :icon-class="apasswordType === 'apassword' ? 'eye' : 'eye-open'" />
        </span>
      </el-form-item>

      <el-button :loading="loading" type="primary" style="width:100%;margin-bottom:30px;" @click.native.prevent="handleregister">注册</el-button>
			<div class="tips">已经有了账号？
...
export default {
  ...
  data() {
    ...
    var validateaPassword = (rule, value, callback) => {
        if (value === '') {
    ...
    return {
      ...
      registerRules: {
        ...
        apassword: [{ required: true, trigger: 'blur', validator: validateaPassword }]
      },
      loading: false,
      passwordType: 'password',
      apasswordType: 'apassword',
      redirect: undefined
    }
  },
  watch: {
  ...
  methods: {
    ...
    showaPwd() {
      if (this.apasswordType === 'apassword') {
        this.apasswordType = ''
      } else {
        this.apasswordType = 'apassword'
      }
      this.$nextTick(() => {
